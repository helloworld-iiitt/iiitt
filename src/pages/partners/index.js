	...
	<Grid item xs={12} sm={10} >
	  ...
	  <section className={classes.sectionPadding}>
		...
		<a href="https://cognizant.com">
		  <img src={require(`../../images/cts-logo.png`)} alt="cts logo" />
		</a>
	      </Grid>
	      <Grid item xs={12} className={classes.logo}>
		Logo of CTS, an American multinational corporation that provides digital, technology, consulting, and operations services.
	      </Grid>
	    </Grid>
	  </section>
	  <section className={classes.sectionPadding}>
	    ...
	    <Typography gutterBottom className={classes.text}>
	      Infosys Limited (formerly Infosys Technologies Limited) is an Indian multinational corporation that provides business consulting, information technology and outsourcing services. It has its headquarters in Bengaluru, India. Infosys is the second-largest Indian IT services company by 2016 revenues, and the largest employer of H-1B visa professionals in the United States. On January 12, 2017, its market capitalisation was $34.38 Billion.
	    </Typography>
	    <Grid gutterBottom>
	      <Grid item xs={12} className={classes.logo}>
		<a href="https://infosys.com">
		  <img src={require(`../../images/infosys-logo.svg`)} alt="infosys logo" />
		</a>
	      </Grid>
	      <Grid item xs={12} className={classes.logo}>
		Logo of Infosys Limited, an Indian multinational corporation that provides business consulting, information technology and outsourcing services.
	      </Grid>
	    </Grid>
	  </section>
	  <section className={classes.sectionPadding}>
		...
		<a href="https://ramco.com">
		  <img src={require(`../../images/ramco-logo.png`)} alt="ramco logo" />
		</a>
	      </Grid>
	      <Grid item xs={12} className={classes.logo}>
		Logo of Ramco Systems Limited, a software products and services provider incorporated in India.
	      </Grid>
	    </Grid>
	  </section>
	  <section className={classes.sectionPadding}>
	  ...
	  <section className={classes.sectionPadding}>
		...
		<a href="https://navitas.net">
		  <img src={require(`../../images/navitas-logo.png`)} alt="navitas logo" />
		</a>
	      </Grid>
	      <Grid item xs={12} className={classes.logo}>
		Logo of Navitas Life Sciences, the dedicated life sciences company of TAKE Solutions.
	      </Grid>
	    </Grid>
	  </section>
	  <section gutterBottom>
	    <Typography className={classes.text}>
	      The Department of Training and Placement is proposed to bring in the services of Industry Partners to help, co-ordinate and arrange for campus placement opportunities to the UG and PG students.
	      <Box component="span" fontWeight="fontWeightBold">
		The advantage of IIIT Trichy is that Industry Partners are one of the stake holders of the Institute. These Industry Partners are willing to offer internships to students during their studies to enrich their programming skills and application of ideas to projects, etc.
	      </Box>
	    </Typography>
	  </section>
	</Grid>

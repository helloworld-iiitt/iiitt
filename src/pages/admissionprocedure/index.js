  ...
  return (
	...
	<Grid item xs={12} sm={10} >
	  ...
	  <Box component="span" fontSize="1.3em">
	    Admission to Undergraduate Programs for the candidates from India at IIIT Trichy is based on the ranks in the Joint Entrance Examination, JEE (Main). Admission to IIIT Trichy for JEE Main qualified candidates is made through a single platform through online by the Joint Seat Allocation Authority (JoSAA).
	  </Box>
	  <br />
	  <br />
	  <section className={classes.sectionPadding} >
		...
		<Box component="span" fontSize="1.2em">
		  The Ministry of Human Resource Development, Government of India has notified following two changes in the JEE pattern for 2019:
		</Box>
	      </Typography>
	  ...
	  <Grid container>
		...
		<ul className="doclist">
		  <li>
		    <a href={require(`../../docs/${rank}`)} className={`${classes.themeText} ${classes.link}`} download={`${rank}`}>{rank}</a>
		  </li>
		</ul>
	      </section>
	    </Grid>

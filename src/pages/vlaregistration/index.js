        ...
        <Grid item xs={12} sm={10}>
          <Card className={classes.infocard}>
            ...
            <Typography className="description">
              Fill up the form with your details to register for the upcoming
              workshops
            </Typography>
          </Card>
          <Card className={classes.infocard}>
            ...
            <Typography className="description">
              Fill up the form with the details of the workshop, to raise a
              request to conduct a virtual workshop through us
            </Typography>
          </Card>
        </Grid>
        <Grid item xs={false} sm={1} />

  ...
  return (
	...
	<Grid item xs={12} sm={10} >
	  ...
	  <Typography gutterBottom className={classes.text}>
	    Festivals create the most extraordinary memories for students during there college life.
	    <br />
	    IIIT Trichy knows this, and thus has created a perfect enviroment where students can celebrate Festivals with full fun.
	  </Typography>
	  {
	    festivals&&festivals.map(festival => {
	      return (
		<section className={classes.sectionPadding}>
		  <Typography component="h1" className={`${classes.themeText} ${classes.title}`} gutterBottom>
		  ...
		  {
		    festival.links&&festival.links.map(link => {
		      return (
			<>
			  {
			    link.download ?
			      <a href={require(`../../docs/${link.url}`)} download={`${link.url}`} className={classes.link}>

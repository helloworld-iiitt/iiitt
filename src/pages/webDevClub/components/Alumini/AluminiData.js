export const AluminiData = [
  {
    ...
    skills:
      "Java, QUARKUS, JBANG, PICOCLI, REACT-JS, NODE-JS, MYSQL, HTML, CSS, DRUPAL 8",
    achievements:
      "GOOGLE SUMMER OF CODE with Redhat(jBoss), IIT BOMBAY (FOSSEE FELLOWSHIP ’19), LENSHOOD (Software Development Intern), IOTREK (Software Development Intern)",

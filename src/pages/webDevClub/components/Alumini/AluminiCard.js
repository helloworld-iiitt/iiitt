    ...
    <div>
      <div className="alumini_card" onClick={() => setHidden()}>
        <div className="alumini_card_top">
          <img src={props.image} alt="profile" className="alumini_profile" />
        </div>
          ...
          <div className="project__detail">
            ...
            <div className="project_detail__page">
              ...
              <div className="project_detail__page_content">
                <h1 className="project_detail__page_name alumini_utility">
                  {" "}
                  {props.name}{" "}
                </h1>
                ...
                <p className="project_detail__page_tech">
                  ...
                  &nbsp;:&nbsp; <p className="contri">{props.skills} </p>
                </p>
                <p className="project_detail__page_contibutors">
                  <span className="utility__desgin utility__color_con">
                    timeline
                  </span>
                  &nbsp; : &nbsp; <p className="contri">{props.achievements}</p>{" "}
                </p>
                <div className="alumini_accounts">
                  <a
                    className="alumini_website alumini_icons"
                    href={props.website}
                  >
                    <LanguageIcon
                      style={{ color: "#f05945", fontSize: "40px" }}
                    />
                  </a>
                  <a className="alumini_icons" href={props.linkdin}>
                    <LinkedInIcon
                      style={{ color: "#0077b5", fontSize: "40px" }}
                    />
                  </a>
                  <a className="alumini_icons" href={props.github}>

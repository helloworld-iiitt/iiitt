export const ProjectData = [
  ...
  },
  {
    ...
    status: "completed",
    description:
      "Official website for the training and placement cell of IIIT Tiruchirappalli",
    tech: "HTML5, CSS3, JS",
  ...
  },
  {
    ...
    status: "completed",
    description:
      "The website where the results are published after each semester",
  ...
  },
  {
    ...
    status: "completed",
    description:
      "The web app used by applicants for the PhD program at IIIT Tiruchirappalli",
    tech: "HTML5, CSS3, Javascript, Django(Python), MariaDB",
    contributors: "Dinesh Vikram V, Nitish kumar",
  },
  {
    key: "6",
    ...
    status: "completed",
    description:
      "utilities for convoaction liek registration form with multipart inputs",

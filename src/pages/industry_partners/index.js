    ...
    componentWillUnmount()  {
      ...
      render(){
        ...
        return(
            ...
            <a href="https://www.tcs.com/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/tcs-logo.svg")} alt="Take me to TCS"/></a>
            </Card>
            ...
            <a href="https://www.cognizant.com/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/cts-logo.png")} alt="Take me to CTS"/></a>
            </Card>
            ...
            <a href="https://www.infosys.com/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/infosys-logo.svg")} alt="Take me to Infosys"/></a>
            </Card>
            ...
            <a href="https://www.ramco.com/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/ramco-logo.png")} alt="Take me to Ramco Systems"/></a>
            </Card>
            ...
            <a href="https://www.elcot.in/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/elcot-logo.png")} alt="Take me to ELCOT"/></a>
            </Card>
            ...
            <a href="https://www.navitaslifesciences.com/"  target="blank" className="imageButton" style={{display:"flex", justifyContent:"centre"}} ><img src={require("../../images/navitas-logo.png")} alt="Take me to Navitas"/></a>
            </Card>
